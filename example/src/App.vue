<template>
  <div id="app">
    ...
    <p class="footer">
      ...
      <svg viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" focusable="false" width="100px" style="pointer-events: none;"><g viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" class="style-scope ytd-topbar-logo-renderer">
